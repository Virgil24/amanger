...
const Planning = () => {
  ...
  const getStateLikeDay = (day) => {
    ...
    if (day.getMonth() < 10 && day.getDate() < 10) {
      stateLikeTransformedDate = `${day.getFullYear()}-0${day.getMonth() + 1}-0${day.getDate()}`;
    }
    else if (day.getMonth() >= 10 && day.getDate() < 10) {
      ...
      stateLikeTransformedDate = `${day.getFullYear()}-0${day.getMonth() + 1}-${day.getDate()}`;
    }
